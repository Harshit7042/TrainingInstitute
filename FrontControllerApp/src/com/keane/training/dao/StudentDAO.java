...
//						
		...
		try {
			...
			final ParamMapper ComplaintStudent=new ParamMapper()
			{
				...
				public void mapParam(PreparedStatement preStmt)
					...
					preStmt.setString(1,r.getSname());
					preStmt.setString(2,r.getSqual());
					preStmt.setInt(3,r.getMarks());
	...
	// TODO Auto-generated method stub
	public static List ViewResponse(final String iid) throws DBFWException {
		ConnectionHolder ch=null;
		Connection con=null;
		List result=null;
